...
include 'config.php';
session_start();//ki ndiro login yabda session 3la hsab user_id
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Remove the item from the shopping cart');></a></td>
         </tr>
      <?php
